...
const Loyihalar: React.FC = () => {
  ...
  const compEdit = async (card: Card) => {
    try {
      navigate(`/admin/tadbirlar/loyihalar/qo'shish`, { state: card });
    } catch (error) {
  ...
  const Qoshish = () => {
    navigate("/admin/tadbirlar/loyihalar/qo'shish");
  };
    ...
    <div className="w-full">
      ...
      >
        <div className="box-border border-b border-gray-300 bg-white">
          <span
            className="static w-[106px] h-[32px] flex flex-row justify-start items-center p-0 text-[24px] font-inter"
            style={{
              fontFamily: "Inter",
              fontStyle: "normal",
              fontWeight: 700,
        ...
        <div className="items-center">
          ...
          >
            <img
              src={Add}
              className="mr-[8px] w-[17px] h-[17px] left-[6px] top-[6px]"
            />
            <span
          ...
          <div className="flex col-sm-4 flex-wrap">
            {cards.map((card) => (
              ...
              >
                ...
                <img
                  className="select-none w-[331px] h-[177px] flex-none order-0 self-stretch flex-grow-0 my-4 ml-[14px] "
                  src={card.photoUrl}
                  alt="Card Image"
                />
                <h3
                  className="w-[331px] h-[24px] mr-[14px] ml-[14px] flex-none order-1 flex-grow-0 font-inter text-[20px] line-clamp-1"
                  style={{
                    color: "rgb(20, 21, 26)",
                    fontFamily: "Inter",
                    fontWeight: 700,
                ...
                <div
                  className="w-[335px] ml-[14px] mr-[14px] line-clamp-4 overflow-hidden text-ellipsis order-[2]"
                  style={{
                    fontFamily: "Inter",
                    whiteSpace: "normal",
                    wordBreak: "break-word",
                  }}
                  dangerouslySetInnerHTML={{ __html: card.descriptionUz }}
                />
                <p 
                  className="w-[335px] ml-[14px] mr-[14px] mt-4 text-sm text-gray-600 line-clamp-4 font-inter"
                  style={{
                    fontFamily: "Inter",
                    fontWeight: 400,
      ...
      >
        ...
        <div className="flex">
          ...
          <div className="pt-[24px] pr-[24px] ml-[20px]">
            <div className="flex items-center ">
              <h4
                className="w-[432px] items-center text-[20px] font-inter"
                style={{
                  color: "rgb(26, 32, 36)",
                  fontFamily: "Inter",
                  fontWeight: 700,
            ...
            >
              Haqiqatan ham ushubu loyihani oʻchirib tashlamoqchimisiz? Bu
        ...
        <div className="pt-[24px] flex justify-end">
          <button
            onClick={handleCancel}
            className="pt-[10px] pr-[18px] pl-[18px] pb-[10px] text-[16px] rounded-lg mr-[12px]"
            style={{
              color: "rgb(26, 32, 36)",
              fontFamily: "Inter",
              fontWeight: 600,
          ...
          <button
            onClick={() => handleOk()}
            className="pt-[10px] pr-[18px] pl-[18px] pb-[10px] text-[16px] rounded-lg"
            style={{
