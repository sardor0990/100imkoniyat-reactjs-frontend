...
import Bg from "../../assets/imgs/tadbirkorlig.png";
import { CardOpportunity } from "../Customs";
import { AntCollapse } from "./style";
import data from "../../Tadbirkorlar2.json";
...
const ForGirls: React.FC = () => {
  ...
  const [category, setCategory] = useState("tadbirkorlik");
  return (
    <div className="w-full flex flex-col items-center gap-[100px]">
      <div className="relative w-full flex flex-col h-[700px] max-[1300px]:h-[450px] max-[1300px]:p-[10px] bg-gradient-to-t from-opacity-60 via-transparent to-transparent backdrop-blur-10 ">
        <div
          style={{
            background:
